...
$sth8 -> execute([$_SESSION['activeAssign']]);
$row8 = $sth8 -> fetch();
...
$sth1 -> execute([$_SESSION['activeAssign'], $_GET['deleteQuestion']]);
$row1 = $sth1 -> fetch();
...
$sth6 -> execute([$_SESSION['activeAssign'], $_GET['deleteQuestion']]);
$row6 = $sth6 -> fetch();
